      ...
      <form onSubmit={handleSubmit} className="p-5 px-6 pb-6">
        <div className="mb-5">
          ...
          <div className="flex items-stretch overflow-hidden rounded-sm border border-border bg-surface focus-within:border-primary">
            ...
            <button
              type="button"
              onClick={() => setName(source.name)}
              className="shrink-0 border-l border-border bg-elevated px-3.5 text-[13px] text-secondary transition-colors hover:bg-hover hover:text-primary whitespace-nowrap"
            >
              填充
            </button>
          </div>
